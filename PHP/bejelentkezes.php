...
if($numrows==1)
{
	...
	else if($felhasznalonev!=dbfelhasznalonev)
		echo "<script type='text/javascript'>alert('A felhasznalonev nem megfelelo')</script>";
}
}
		...
		<center>
			<table style="">
				<tr>
					...
					<td class=input><input type=text name=felhasznalonev value="<?php if(isset($_POST['submit']) and $_POST['felhasznalonev'] and $_POST['password']) echo $felhasznalonev; ?>"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan=2>
						<center><input type=submit value="Elk&uuml;ld" name=submit><center>
					</td>
				</tr>
				<tr>
					<td colspan=2>
